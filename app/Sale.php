...
class Sale extends Model
{
    ...
    function scopeWithAll($query) {
        $query->with('client.iva_condition', 'client.price_type', 'buyer.comercio_city_client', 'articles', 'impressions', 'special_price', 'commissions', 'discounts', 'surchages', 'afip_ticket', 'combos', 'order.cupon', 'services', 'employee', 'budget.articles', 'budget.client');
    }
    ...
    public function surchages() {
        return $this->belongsToMany('App\Surchage')->withPivot('percentage');
    }
